...
MODEL_REGISTRY: Dict[str, Dict[str, Any]] = {
    "gaze_only": {
        ...
        "checkpoint": "checkpoints/gaze_only.pt",
        "prediction_file": "results/predictions/gaze_only.csv",
    },
    "interaction_only": {
        "name": "Interaction-only",
        "constructor": InteractionOnlyModel,
        "required_streams": ("interaction",),
        "checkpoint": "checkpoints/interaction_only.pt",
        "prediction_file": "results/predictions/interaction_only.csv",
    },
    "environment_only": {
        "name": "Environment-only",
        "constructor": EnvironmentOnlyModel,
        "required_streams": ("environment",),
        "checkpoint": "checkpoints/environment_only.pt",
        "prediction_file": "results/predictions/environment_only.csv",
    },
    "gaze_interaction": {
        "name": "Gaze + Interaction",
        "constructor": GazeInteractionModel,
        "required_streams": ("gaze", "interaction"),
        "checkpoint": "checkpoints/gaze_interaction.pt",
        "prediction_file": "results/predictions/gaze_interaction.csv",
    },
    "gaze_environment": {
        "name": "Gaze + Environment",
        "constructor": GazeEnvironmentModel,
        "required_streams": ("gaze", "environment"),
        "checkpoint": "checkpoints/gaze_environment.pt",
        "prediction_file": "results/predictions/gaze_environment.csv",
    },
    "interaction_environment": {
        "name": "Interaction + Environment",
        "constructor": InteractionEnvironmentModel,
        "required_streams": ("interaction", "environment"),
        "checkpoint": "checkpoints/interaction_environment.pt",
        "prediction_file": "results/predictions/interaction_environment.csv",
    },
    "early_fusion": {
        "name": "Early Fusion",
        "constructor": EarlyFusionModel,
        "required_streams": ("gaze", "interaction", "environment"),
        "checkpoint": "checkpoints/early_fusion.pt",
        "prediction_file": "results/predictions/early_fusion.csv",
    },
    "late_fusion": {
        "name": "Late Fusion",
        "constructor": LateFusionModel,
        "required_streams": ("gaze", "interaction", "environment"),
        "checkpoint": "checkpoints/late_fusion.pt",
        "prediction_file": "results/predictions/late_fusion.csv",
    },
    "attention_fusion": {
        ...
        "prediction_file": "results/predictions/attention_fusion.csv",
    },
}
