...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "exam-proctoring")))

from gaze.feature_extractor import GazeFeatureExtractor, TORCH_AVAILABLE
